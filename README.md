...
> /dev/null 2>&1 &
```
#HeapDumpOnOutOfMemoryError в случае когда приклад падает с ошибкой нехватки хипа, то будет сделан хип дамп в папку указанную в HeapDumpPath
  # отслеживание загрузки и выгрузки классов
